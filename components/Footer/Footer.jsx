...
const Footer = () => {
  return (
    <footer className="mt-10 py-5 border-t-2 text-black/50">
      <Container>
        <div className="flex flex-col md:flex-row gap-5 md:gap-0 justify-between items-center">
          <div className="flex flex-col items-center md:items-start sm:w-[250px] md:w-[350px]">
            ...
            <p className="opacity-50 text-center md:text-start">Simplifiez votre expérience shopping avec notre sélection de produits de qualité.</p>
          </div>
        ...
        <div className="mt-10 text-center text-sm opacity-75">© 2024 Shopika. Tous droits réservés.</div>
      </Container>
    </footer>
  );
};
