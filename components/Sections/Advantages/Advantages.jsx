...
const Advantages = () => {
  return (
    <section className="py-10 mb-36 bg-tertiary flex justify-center items-center">
      <Container>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 justify-items-center">
          {advantages.map((advantage, index) => (
            <div key={index} className="border border-secondary flex flex-col justify-center items-center text-white px-5 gap-4 w-5/6 h-[300px] rounded-lg">
