    ...
    <Container>
      <div className="min-h-screen pt-32 space-y-8">
        ...
        <p className="leading-7">
          Nous sommes là pour vous aider. Que ce soit pour une question, une suggestion ou une
          réclamation, n’hésitez pas à nous contacter. Notre équipe se fera un plaisir de vous
        ...
        <section className="space-y-6">
          ...
          <p>
            Restez informé de nos dernières nouveautés et offres spéciales en nous suivant sur les
            réseaux sociaux :
          </p>
